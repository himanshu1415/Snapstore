...
if(form.getvalue("register")):
    ...
    try:
        ...
        res=cur.fetchall()
        print('<br><br><br><table border="1" width="100%">')
...
print('<marquee behavior="left" scrollamount="10" style="margin-left:sem;margin-right:sem;">Please be aware that this Registration Form, when completed, along with the Guide and the Declaration of Acceptance, is your contract with Snapstore and that in signing you are agreeing to the terms and conditions listed below</marquee>')
